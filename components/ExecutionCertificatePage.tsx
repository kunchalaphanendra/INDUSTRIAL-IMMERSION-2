...
const ExecutionCertificatePage: React.FC<CertificatePageProps> = ({ onBack }) => {
  useEffect(() => {
    window.scrollTo(0, 0);
    document.title = "Execution Certificate | STJUFENDS";
  }, []);
        ...
        <div className="glass-card p-12 md:p-20 rounded-[3rem] border-blue-500/20 relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <h1 className="text-4xl md:text-6xl font-heading font-bold uppercase tracking-tighter mb-8">
              Execution <br /><span className="text-blue-500">Certificate</span>
            </h1>
            
            <div className="space-y-8 text-gray-400 font-medium text-lg leading-relaxed">
              <p>
                The Execution Certificate is a standardized industrial credential issued by STJUFENDS to verify a participant's ability to execute specific business process flows.
              </p>
              
              <div className="space-y-4 pt-8">
                <h3 className="text-white font-bold uppercase tracking-widest text-sm">What it verifies:</h3>
                {[
                  "Adherence to defined operational process flows",
                  "Successful delivery of assigned business deliverables",
                  "Competency in industry-standard execution tools",
                  "Professional accountability and reporting standards"
                ].map((item, i) => (
...
export default ExecutionCertificatePage;
